...
def train_and_export():
    ...
    # 3. Normalize (Using FIXED range for consistency with Android app)
    # Calibrated range: 2.0 - 25.0 mmol/L
    CALIBRATION_MIN = 2.0
    CALIBRATION_MAX = 25.0

    scaled_data = (values - CALIBRATION_MIN) / (CALIBRATION_MAX - CALIBRATION_MIN)
