...
import com.example.nhatkyduonghuyet.viewmodel.StatsViewModel_HiltModules;
...
public final class DaggerNhatKyDuongHuyetApplication_HiltComponents_SingletonC {
  private DaggerNhatKyDuongHuyetApplication_HiltComponents_SingletonC() {
  }
  ...
  public static final class Builder {
    ...
    public NhatKyDuongHuyetApplication_HiltComponents.SingletonC build() {
      Preconditions.checkBuilderRequirement(applicationContextModule, ApplicationContextModule.class);
      return new SingletonCImpl(applicationContextModule);
    }
  }

  private static final class ActivityRetainedCBuilder implements NhatKyDuongHuyetApplication_HiltComponents.ActivityRetainedC.Builder {
    ...
    @Override
    public NhatKyDuongHuyetApplication_HiltComponents.ActivityRetainedC build() {
      Preconditions.checkBuilderRequirement(savedStateHandleHolder, SavedStateHandleHolder.class);
      return new ActivityRetainedCImpl(singletonCImpl, savedStateHandleHolder);
    }
  }

  private static final class ActivityCBuilder implements NhatKyDuongHuyetApplication_HiltComponents.ActivityC.Builder {
    private final SingletonCImpl singletonCImpl;
    ...
    @Override
    public NhatKyDuongHuyetApplication_HiltComponents.ActivityC build() {
      Preconditions.checkBuilderRequirement(activity, Activity.class);
      return new ActivityCImpl(singletonCImpl, activityRetainedCImpl, activity);
    }
  }

  private static final class FragmentCBuilder implements NhatKyDuongHuyetApplication_HiltComponents.FragmentC.Builder {
    private final SingletonCImpl singletonCImpl;
    ...
    @Override
    public NhatKyDuongHuyetApplication_HiltComponents.FragmentC build() {
      Preconditions.checkBuilderRequirement(fragment, Fragment.class);
      return new FragmentCImpl(singletonCImpl, activityRetainedCImpl, activityCImpl, fragment);
    }
  }

  private static final class ViewWithFragmentCBuilder implements NhatKyDuongHuyetApplication_HiltComponents.ViewWithFragmentC.Builder {
    private final SingletonCImpl singletonCImpl;
    ...
    @Override
    public NhatKyDuongHuyetApplication_HiltComponents.ViewWithFragmentC build() {
      Preconditions.checkBuilderRequirement(view, View.class);
      return new ViewWithFragmentCImpl(singletonCImpl, activityRetainedCImpl, activityCImpl, fragmentCImpl, view);
    }
  }

  private static final class ViewCBuilder implements NhatKyDuongHuyetApplication_HiltComponents.ViewC.Builder {
    private final SingletonCImpl singletonCImpl;
    ...
    @Override
    public NhatKyDuongHuyetApplication_HiltComponents.ViewC build() {
      Preconditions.checkBuilderRequirement(view, View.class);
      return new ViewCImpl(singletonCImpl, activityRetainedCImpl, activityCImpl, view);
    }
  }

  private static final class ViewModelCBuilder implements NhatKyDuongHuyetApplication_HiltComponents.ViewModelC.Builder {
    private final SingletonCImpl singletonCImpl;
    ...
    @Override
    public NhatKyDuongHuyetApplication_HiltComponents.ViewModelC build() {
  ...
  private static final class ServiceCBuilder implements NhatKyDuongHuyetApplication_HiltComponents.ServiceC.Builder {
    private final SingletonCImpl singletonCImpl;
    ...
    @Override
    public NhatKyDuongHuyetApplication_HiltComponents.ServiceC build() {
      Preconditions.checkBuilderRequirement(service, Service.class);
      return new ServiceCImpl(singletonCImpl, service);
    }
  }

  private static final class ViewWithFragmentCImpl extends NhatKyDuongHuyetApplication_HiltComponents.ViewWithFragmentC {
    private final SingletonCImpl singletonCImpl;
  ...
  private static final class FragmentCImpl extends NhatKyDuongHuyetApplication_HiltComponents.FragmentC {
    private final SingletonCImpl singletonCImpl;
  ...
  private static final class ViewCImpl extends NhatKyDuongHuyetApplication_HiltComponents.ViewC {
    private final SingletonCImpl singletonCImpl;
  ...
  private static final class ActivityCImpl extends NhatKyDuongHuyetApplication_HiltComponents.ActivityC {
    private final SingletonCImpl singletonCImpl;
    ...
    public Map<Class<?>, Boolean> getViewModelKeys() {
      return LazyClassKeyMap.<Boolean>of(MapBuilder.<String, Boolean>newMapBuilder(4).put(LazyClassKeyProvider.com_example_nhatkyduonghuyet_ui_dashboard_DashboardViewModel, DashboardViewModel_HiltModules.KeyModule.provide()).put(LazyClassKeyProvider.com_example_nhatkyduonghuyet_viewmodel_DetailViewModel, DetailViewModel_HiltModules.KeyModule.provide()).put(LazyClassKeyProvider.com_example_nhatkyduonghuyet_viewmodel_LogEntryViewModel, LogEntryViewModel_HiltModules.KeyModule.provide()).put(LazyClassKeyProvider.com_example_nhatkyduonghuyet_viewmodel_StatsViewModel, StatsViewModel_HiltModules.KeyModule.provide()).build());
    }
  ...
  private static final class ViewModelCImpl extends NhatKyDuongHuyetApplication_HiltComponents.ViewModelC {
    private final SingletonCImpl singletonCImpl;
    ...
    private Provider<LogEntryViewModel> logEntryViewModelProvider;
    ...
    private void initialize(final SavedStateHandle savedStateHandleParam,
      ...
      this.logEntryViewModelProvider = new SwitchingProvider<>(singletonCImpl, activityRetainedCImpl, viewModelCImpl, 2);
      this.statsViewModelProvider = new SwitchingProvider<>(singletonCImpl, activityRetainedCImpl, viewModelCImpl, 3);
    }

    @Override
    public Map<Class<?>, javax.inject.Provider<ViewModel>> getHiltViewModelMap() {
      return LazyClassKeyMap.<javax.inject.Provider<ViewModel>>of(MapBuilder.<String, javax.inject.Provider<ViewModel>>newMapBuilder(4).put(LazyClassKeyProvider.com_example_nhatkyduonghuyet_ui_dashboard_DashboardViewModel, ((Provider) dashboardViewModelProvider)).put(LazyClassKeyProvider.com_example_nhatkyduonghuyet_viewmodel_DetailViewModel, ((Provider) detailViewModelProvider)).put(LazyClassKeyProvider.com_example_nhatkyduonghuyet_viewmodel_LogEntryViewModel, ((Provider) logEntryViewModelProvider)).put(LazyClassKeyProvider.com_example_nhatkyduonghuyet_viewmodel_StatsViewModel, ((Provider) statsViewModelProvider)).build());
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          ...
          return (T) new DashboardViewModel(singletonCImpl.bindLogRepositoryProvider.get(), singletonCImpl.provideRealtimePredictorProvider.get(), new DetectRiskPattern(), singletonCImpl.aIRepositoryProvider.get(), new GeminiAnalysisUseCase());
  ...
  private static final class ActivityRetainedCImpl extends NhatKyDuongHuyetApplication_HiltComponents.ActivityRetainedC {
    private final SingletonCImpl singletonCImpl;
  ...
  private static final class ServiceCImpl extends NhatKyDuongHuyetApplication_HiltComponents.ServiceC {
    private final SingletonCImpl singletonCImpl;
  ...
  private static final class SingletonCImpl extends NhatKyDuongHuyetApplication_HiltComponents.SingletonC {
    ...
    @Override
    public void injectNhatKyDuongHuyetApplication(
        NhatKyDuongHuyetApplication nhatKyDuongHuyetApplication) {
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          case 0: // com.example.nhatkyduonghuyet.ml.GlucosePredictor 
          ...
          return (T) new AIRepository(ApplicationContextModule_ProvideContextFactory.provideContext(singletonCImpl.applicationContextModule), singletonCImpl.logEntryDao(), singletonCImpl.provideLSTMEngineProvider.get());
